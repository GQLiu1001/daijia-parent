...
public class OcrServiceImpl implements OcrService {
    ...
    @Override
    public IdCardOcrVo idCardOcr(MultipartFile file) throws IOException, TencentCloudSDKException {
        //图片转为base64字符串
        byte[] bytes = Base64.encode(file.getBytes());
        ...
        // 实例化一个请求对象IDCardOCRResponse,每个接口都会对应一个request对象
        IDCardOCRRequest req = new IDCardOCRRequest();
        req.setImageBase64(fileBase64);
        // IDCardOCRResponse，与请求对象对应
